...
const SERVICE_ID = 'service_amgvqz4'
const TEMPLATE_ID = 'template_f96vipk'
const PUBLICK_KEY = 'wJPeKqZSgkPDBJ7kN'
  ...
  const handleSubmit = (e)=>{
    e.preventDefault()
    emailjs.sendForm(SERVICE_ID, TEMPLATE_ID, e.target, PUBLICK_KEY).then((result)=>{
      alert('Message Sent !')
      setFormData({name: '',
        email: '',
        message: ''})
